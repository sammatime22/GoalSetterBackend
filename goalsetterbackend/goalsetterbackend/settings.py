"""
Django settings for goalsetterbackend project.
...
ROOT_URLCONF = 'goalsetterbackend.urls'
...
WSGI_APPLICATION = 'goalsetterbackend.wsgi.application'
...
USE_TZ = False # True # Set to false for now
